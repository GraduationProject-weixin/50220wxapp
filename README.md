...
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用英语互助小程序可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用英语互助小程序，其意义如下：

第一点：英语互助小程序的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对英语互助小程序设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对英语互助小程序进行介绍时，将按照如下内容进行。

第一部分：介绍英语互助小程序研究的背景意义，便于用户了解系统；

第二部分：介绍开发英语互助小程序需要搭建的环境，包括技术和工具；

第三部分：介绍用户对英语互助小程序的功能要求，以及对英语互助小程序的性能要求等；
...
# 第2章 开发环境与技术
英语互助小程序的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对英语互助小程序用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，英语互助小程序开发可行。
### 3.1.3 操作可行性
英语互助小程序根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作英语互助小程序。
...
![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\用户.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\用户.jpg")
图4.1 用户实体属性图

（2）下图是考试记录表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\考试记录表.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\考试记录表.jpg")
图4.2 考试记录表实体属性图

（3）下图是兴趣小组实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\兴趣小组.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\兴趣小组.jpg")
图4.3 兴趣小组实体属性图

（4）下图是小组打卡实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\小组打卡.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\小组打卡.jpg")
图4.4 小组打卡实体属性图

（5）下图是答题详情表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\答题详情表.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\答题详情表.jpg")
图4.5 答题详情表实体属性图

（6）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\公告信息.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\公告信息.jpg")
图4.6 公告信息实体属性图

（7）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\字典表.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\字典表.jpg")
图4.7 字典表实体属性图

（8）下图是加入的小组实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\加入的小组.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\加入的小组.jpg")
图4.8 加入的小组实体属性图

（9）下图是错题表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\错题表.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\错题表.jpg")
图4.9 错题表实体属性图

（10）下图是学习讨论实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\学习讨论.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\学习讨论.jpg")
图4.10 学习讨论实体属性图

（11）下图是客服聊天实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\客服聊天.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\客服聊天.jpg")
图4.11 客服聊天实体属性图

（12）下图是试卷表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\试卷表.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\试卷表.jpg")
图4.12 试卷表实体属性图

（13）下图是资讯收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\资讯收藏.jpg](/md/blog.018.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\资讯收藏.jpg")
图4.13 资讯收藏实体属性图

（14）下图是资讯评论实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\资讯评论.jpg](/md/blog.019.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\资讯评论.jpg")
图4.14 资讯评论实体属性图

（15）下图是主题资讯实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\主题资讯.jpg](/md/blog.020.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\主题资讯.jpg")
图4.15 主题资讯实体属性图

（16）下图是试题表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\试题表.jpg](/md/blog.021.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\试题表.jpg")
图4.16 试题表实体属性图

（17）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\用户表.jpg](/md/blog.022.jpeg "C:\Users\Administrator\Desktop\img\yingyuhuzhuxiaochengxu\用户表.jpg")
图4.17 用户表实体属性图
### 4.3.1 数据库物理设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xingquxiaozu\_id|Integer|小组|是|
|3|yonghu\_id|Integer|用户|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xingquxiaozu\_name|String|小组名称|是|
|3|xingquxiaozu\_photo|String|小组封面|是|
|4|xingquxiaozu\_types|Integer|小组类型|是|
|5|zhuanye\_types|Integer|专业|是|
|6|shuiping\_types|Integer|英语水平|是|
|7|xingquxiaozu\_address|String|所属地点|是|
|8|yonghu\_id|Integer|小组组长|是|
|9|xingquxiaozu\_content|String|小组简介|是|
|10|create\_time|Date|创建时间|是|
表4.12小组打卡表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xingquxiaozu\_id|Integer|兴趣小组|是|
|3|yonghu\_id|Integer|用户|是|
|4|xingquxiaozu\_liuyan\_text|String|小组打卡内容|是|
|5|insert\_time|Date|小组打卡时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zhutizixun\_name|String|资讯标题|是|
|3|zhutizixun\_types|Integer|资讯类型|是|
|4|zhutizixun\_photo|String|资讯封面|是|
|5|zhutizixun\_video|String|资讯视频|是|
|6|zan\_number|Integer|赞|是|
|7|cai\_number|Integer|踩|是|
|8|insert\_time|Date|发布时间|是|
|9|zhutizixun\_content|String|资讯内容|是|
|10|create\_time|Date|创建时间|是|
表4.15资讯收藏表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zhutizixun\_id|Integer|主题资讯|是|
|3|yonghu\_id|Integer|用户|是|
|4|zhutizixun\_collection\_types|Integer|类型|是|
...
|2|zhutizixun\_id|Integer|主题资讯|是|
|3|yonghu\_id|Integer|用户|是|
|4|zhutizixun\_liuyan\_text|String|评论内容|是|
...
图5.3 小组打卡管理页面
### 5.1学习讨论管理
如图5.4显示的就是学习讨论管理页面，此页面提供给管理员的功能有：根据学习讨论进行新增、修改、查询操作等等。
